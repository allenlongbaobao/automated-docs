(function(){
  var requestCreateANewWebInterestingPoint;
  requestCreateANewWebInterestingPoint = {
    type: 'web',
    title: '无法阻挡的@+',
    content: '人类已经无法阻挡@+了',
    withinLocation: {
...
(function(){
  var requestCreateANewWebInterestingPointOnANewUrl;
  requestCreateANewWebInterestingPointOnANewUrl = {
    type: 'web',
