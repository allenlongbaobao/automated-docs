messages =
  ...
  * _id: 'mid-3'
    ...
    ipsid: 'ipsid-3'# interesting point session id
    replies-count: 0 # 当type为ips-msg时才有的属性，表示回复数量！！！！！！！！
    original-content-type: 'text' # text | voice
    text-content: '快乐无极限' # When origin content is voice, it will be interpreted text. May be HTML for colorful messages.
    voice-content: '/voice/0'
  ...
  * _id: 'mid-4'
    type: 'ips-msg' # ips-msg | ip-rpl | chat-msg
    ipid: 'ipid-4' # interesting point id
    ipsid: 'ipsid-4'# interesting point session id
    replies-count: 0 # 当type为ips-msg时才有的属性，表示回复数量！！！！！！！！
    original-content-type: 'text' # text | voice
    text-content: '快乐无极限' # When origin content is voice, it will be interpreted text. May be HTML for colorful messages.
    voice-content: '/voice/0'
  ...
  * _id: 'mid-5'
    type: 'ips-msg' # ips-msg | ip-rpl | chat-msg
    ipid: 'ipid-5' # interesting point id
    ipsid: 'ipsid-5'# interesting point session id
    replies-count: 0 # 当type为ips-msg时才有的属性，表示回复数量！！！！！！！！
    original-content-type: 'text' # text | voice
    text-content: '快乐无极限' # When origin content is voice, it will be interpreted text. May be HTML for colorful messages.
    voice-content: '/voice/0'
  ...
  * _id: 'mid-5'
    type: 'ips-msg' # ips-msg | ip-rpl | chat-msg
    ipid: 'ipid-6' # interesting point id
    ipsid: 'ipsid-6'# interesting point session id
    replies-count: 0 # 当type为ips-msg时才有的属性，表示回复数量！！！！！！！！
    original-content-type: 'text' # text | voice
    text-content: '快乐无极限' # When origin content is voice, it will be interpreted text. May be HTML for colorful messages.
    voice-content: '/voice/0'
