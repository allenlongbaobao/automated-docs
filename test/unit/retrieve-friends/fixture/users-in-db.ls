users =
  ...
  * _id: 'uid-2'
    ...
    group-chats:
      * cid: 'cid-2'
        ...
        last-access-time: '2013-04-02 22:11:04' # 用于查询未读的聊天信息
      ...
    leave-chats: ['cid-3', 'cid-4'] # 曾经参加，但是现在退出
  ...
  * _id: 'uid-3'
    ...
    emails: # emails[0]为主email
      ...
      ...
    avatars: # avatars[0]是当前使用的。
      '/avatars/u/uid/3' # u开头是用户上传的，资源为：http://at-plus-server/avatars/u/uid/2
      '/avatars/u/uid/1' # 资源为：http://at-plus-server/avatars/u/uid/2
      '/avatars/s/1'     # s开头是系统提供的资源为：http://at-plus-server/avatars/s/1
    signatures: # signatures[0]为当前使用的
      '彪悍的人生不需要解释'
  ...
  * _id: 'uid-4'
    ...
    emails: # emails[0]为主email
      ...
      ...
    avatars: # avatars[0]是当前使用的。
      '/avatars/u/uid/4' # u开头是用户上传的，资源为：http://at-plus-server/avatars/u/uid/2
      '/avatars/u/uid/1' # 资源为：http://at-plus-server/avatars/u/uid/2
      '/avatars/s/1'     # s开头是系统提供的资源为：http://at-plus-server/avatars/s/1
    signatures: # signatures[0]为当前使用的
      '彪悍的人生不需要解释'
  ...
  * _id: 'uid-5'
    ...
    emails: # emails[0]为主email
      ...
      ...
    avatars: # avatars[0]是当前使用的。
      '/avatars/u/uid/5' # u开头是用户上传的，资源为：http://at-plus-server/avatars/u/uid/2
      '/avatars/u/uid/1' # 资源为：http://at-plus-server/avatars/u/uid/2
      '/avatars/s/1'     # s开头是系统提供的资源为：http://at-plus-server/avatars/s/1
    signatures: # signatures[0]为当前使用的
      '彪悍的人生不需要解释'
